...
Откроется **интерактивный TUI-калькулятор** — форма, в которой вы вводите целевую интенсивность, время скрипта и инструмент, а результаты пересчитываются на лету. Без конфига и флагов. Самый быстрый способ проверить одиночный сценарий.
